...
if fps == 0:
    fps = 25  # Set a default FPS value if it's not available

# Define the codec and create VideoWriter object for saving marked video
codec = cv2.VideoWriter_fourcc(*'DIVX')
out_video = cv2.VideoWriter('C:/Users/varun/Desktop/CG mini/Captured images/output.avi', codec, 2 * fps, (frame_width, frame_height))
...
while cap.isOpened():
    ...
    # Save the frame every second, regardless of motion detection
    if frame_number % (2 * fps) == 0:
...
# Optionally, save a video with marked motion regions
# VideoWriter object has already been released above
