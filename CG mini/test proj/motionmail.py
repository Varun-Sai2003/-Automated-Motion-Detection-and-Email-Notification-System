...
while cap.isOpened():
    ...
    if motion_detected:
        ...
        plt.title(f'Motion Detection Frame {frame_number}')
        plt.savefig(f'motion_detection_{frame_number}.png')  # Save the plot instead of displaying interactively
        plt.close()  # Close the plot to release resources
        
        # Optionally, send an email notification with the captured image
        send_email_notification(f'motion_detection_{frame_number}.png')
